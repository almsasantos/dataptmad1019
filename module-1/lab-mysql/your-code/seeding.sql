...
-- Since the values are attributes for all columns, after specify the table there's no need to specify all columns.
-- Insert values into the columns of the table cars:
INSERT INTO cars 
...
-- Insert values into the columns of the table customers:
...
-- Insert values into the columns of the table salespersons:
...
-- Insert values into the columns of the table invoices:
